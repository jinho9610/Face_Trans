...
if __name__ == "__main__":
    ...
    ## two
    lr_steps = [10000, 20000, 30000, 40000, 49000, 60000, 70000, 80000, 90000, 90000]
    restarts = [50000]
    restart_weights = [1]
    ...
    lr_steps = [
        ...
        600000, 650000, 700000, 740000, 800000, 800000, 900000, 950000, 990000
    ]
